...
- `org-directory/` — Wave P1 location registry app (login, My profile, consumer APIs). P0 still unsigned.
- `rbac/` — HNWMS RBAC contract **APPROVED and applied 2026-09-09** (`engine.py` + `/api/rbac/evaluate`).
