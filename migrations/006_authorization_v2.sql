-- Migration 006: Authorization v2 shadow schema (additive — does not alter v1 tables)
-- Apply:   sqlite3 org_directory.db < 006_authorization_v2.sql
-- Rollback: see 006_authorization_v2_rollback.sql
-- Depends: migration 005 (identity_account_v2)
-- Source:  rbac-v2/part-3-authorization/authorization_schema.sql
...
-- Draft-only catalogue edit triggers
...
-- Delegation bounds and immutability triggers
...
INSERT INTO schema_version (version, description) VALUES
    (6, 'Authorization v2 shadow schema — policy, roles, grants, SoD, delegation, decisions');
