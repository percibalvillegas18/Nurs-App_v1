-- Migration 007: Clinical Safety v2 shadow schema (additive — does not alter v1 tables)
-- Apply:   sqlite3 org_directory.db < 007_clinical_safety_v2.sql
-- Rollback: see 007_clinical_safety_v2_rollback.sql
-- Depends: migrations 005 (identity), 006 (authorization)
-- Source:  rbac-v2/part-4-clinical-safety/clinical_safety_schema.sql
...
-- Auto-alert on break-glass activation
...
INSERT INTO schema_version (version, description) VALUES
    (7, 'Clinical Safety v2 shadow schema — eligibility, guardrails, break-glass, safety decisions');
