-- HNWMS RBAC v2 Part 2: additive identity shadow schema for SQLite validation.
-- This file does not alter current runtime tables and is not loaded by seed.py.
